...
async def Callbacks(event):
    ...
    try:
        ...
        #c = os.popen(f"screen -S {phone_number} -dm bash -c 'git clone https://github.com/sh3oo6/nshr_uu.git && mv nshr_uu {phone_number} && cd {phone_number} && python3 new_nshr_DEX.py; exec sh")
    except :pass
